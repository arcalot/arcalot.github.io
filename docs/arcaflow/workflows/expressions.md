...
In this case, we do not need to know the schema name of the type output generated by `bindConstants()`. If you need to reference the scehma of the list items returned by `bindConstants()`, see [Generated Schema Name](schemas.md#generated-combined-schema-names).