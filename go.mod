...
require (
	go.flow.arcalot.io/dockerdeployer v0.7.4
	go.flow.arcalot.io/kubernetesdeployer v0.10.2
	go.flow.arcalot.io/pluginsdk v0.14.3
	go.flow.arcalot.io/podmandeployer v0.11.5
)
...
require (
	...
	k8s.io/api v0.33.0-alpha.2 // indirect
